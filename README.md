...
- **Engagement** — the stakeholder tracker: Agenda (pick a forum — a 1-1, a steering group, any regular contact — and it generates what to raise from the live items, then logs the meeting, stamps what you covered and captures the actions agreed, in one undoable step), Actions (everything outstanding across every forum — what you owe and what you're waiting on, most overdue first), Log (every logged contact, newest first, filterable by person or forum, plus ad-hoc conversation capture) and People (the roster, away dates, forum membership, a per-stakeholder dossier, and export/import of the tracker). Any agenda copies out as Markdown to paste into the invite, and any concern in Reporting can be handed straight to a stakeholder as a topic to raise, linked back to the group it came from. Deliberately **not** part of the project graph: stakeholders, forums and the comms log are workspace-scoped and shared across every project, in their own store with its own undo history.
